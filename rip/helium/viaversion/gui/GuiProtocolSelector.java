package rip.helium.viaversion.gui;
...
import rip.helium.viaversion.utils.ProtocolSorter;
...
public class GuiProtocolSelector extends GuiScreen {
    ...
    public void drawScreen(int drawScreen, int mouseX, float mouseY) {
        ...
        this.drawCenteredString(this.fontRendererObj, EnumChatFormatting.BOLD.toString() + "ViaVersion",this.width / 4, 6, 16777215);
        GL11.glPopMatrix();
