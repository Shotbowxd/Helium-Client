...
public class PropertySlider extends PropertyComponent {
    ...
    public void drawComponent(final double x, final double y) {
        ...
        if (this.typing) {
            ...
            Fonts.f12.drawCenteredString(Mafs.round(this.property.getValue(), 2) + this.property.getNumType(), (float) (x + 80.0 + this.currentPosition), (float) (y + this.maxHeight / 2.0), this.typing ? this.theInterface.getColor(255, 255, 255) : this.theInterface.getColor(255, 255, 255));
        }
