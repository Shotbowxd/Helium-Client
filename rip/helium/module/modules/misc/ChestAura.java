...
public class ChestAura extends Module {
	...
	private final Timer resetPositions;
	private int position;
	
	public ChestAura(int bind, String name, String displayName, Category category) {
		super(bind, name, displayName, category);
		this.setColor(ColorUtils.generateColor());
		
		this.blackListedLocation = new ArrayList<BlockPos>();
		this.resetPositions = new Timer();
	}
	...
	public void onEnable() {
		super.onEnable();
		this.resetPositions.updateLastTime();
	}
	...
	public void setYaw(UpdateEvent e, final float yaw) {
        final boolean notarget = !mc.hackedClient.getModuleManager().getModule("KillAura").getState();
        if (notarget) {
            e.setYaw(yaw);
        }
    }
