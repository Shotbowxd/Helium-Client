...
public class BigUIButton extends GuiButton {

    public BigUIButton(final int buttonId, final int x, final int y, final String buttonText) {
        this(buttonId, x, y, 220, 30, buttonText);

    }

    public BigUIButton(final int buttonId, final int x, final int y, final int widthIn, final int heightIn, final String buttonText) {
