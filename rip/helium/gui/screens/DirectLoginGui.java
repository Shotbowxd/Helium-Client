...
public class DirectLoginGui extends GuiScreen
{
    ...
    @Override
    public void initGui() {
        this.usernameField = new TextField(mc.fontRendererObj, this.width / 2 - 75, this.height / 2 - 42, 150, 20);
        this.passwordField = new TextField(mc.fontRendererObj, this.width / 2 - 75, this.height / 2 - 20, 150, 20);
        this.tokenField = new TextField(mc.fontRendererObj, this.width / 2 - 75, this.height / 2 - 20, 150, 20);
        ...
        this.serviceDropbox = new Dropbox(this.width / 2 - 40, this.height / 2 + 7, 80, 15, mc.fontRendererObj, 0, new String[] { "Mojang", "Altening" });
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        Render2DUtils.drawImg(new ResourceLocation("dotexe/title.jpg"), 1.0, 1.0, this.width, this.height);
        ...
        this.drawCenteredString(mc.fontRendererObj, mc.hackedClient.getAccountLoginService().getStatus(), (this.width / 2), (this.height - 12), -1);
    }
    ...
    public void loginAccount() {
        if (this.serviceDropbox.getSelected().equals("Mojang")) {
            ...
            mc.hackedClient.getAccountLoginService().attemptLogin(new Account(this.usernameField.getTypedContent(), this.passwordField.getTypedContent(), service));
        }
      /*  else {
