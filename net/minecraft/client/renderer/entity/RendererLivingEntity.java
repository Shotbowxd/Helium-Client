...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    {
    	if(Minecraft.getMinecraft().hackedClient.getModuleManager().getModule("Chams").getState()) {
    		if (entity != Minecraft.getMinecraft().thePlayer && (entity instanceof EntityPlayer && ((Targeting)Minecraft.getMinecraft().hackedClient.getModuleManager().getModule("Targeting")).players.getValBoolean())
                    || (entity instanceof EntityMob && ((Targeting)Minecraft.getMinecraft().hackedClient.getModuleManager().getModule("Targeting")).monsters.getValBoolean())
                    || (entity instanceof EntitySlime && ((Targeting)Minecraft.getMinecraft().hackedClient.getModuleManager().getModule("Targeting")).monsters.getValBoolean())
                    || (entity instanceof EntityAnimal && ((Targeting)Minecraft.getMinecraft().hackedClient.getModuleManager().getModule("Targeting")).animals.getValBoolean())
                    || (entity instanceof EntityPig && ((Targeting)Minecraft.getMinecraft().hackedClient.getModuleManager().getModule("Targeting")).animals.getValBoolean())
                    || (entity instanceof EntityVillager && ((Targeting)Minecraft.getMinecraft().hackedClient.getModuleManager().getModule("Targeting")).villagers.getValBoolean())
                    || (entity instanceof EntityGolem && ((Targeting)Minecraft.getMinecraft().hackedClient.getModuleManager().getModule("Targeting")).golems.getValBoolean())) {
    			GL11.glEnable(32823);
        ...
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)}))
        {
            ...
            try
            {
                ...
                //TODO: Client
                if(entity == Minecraft.getMinecraft().thePlayer) f8 = Minecraft.getMinecraft().thePlayer.getServerSidePitch();
