...
public class LayerDeadmau5Head implements LayerRenderer<AbstractClientPlayer>
{
    ...
    {
        if ((entitylivingbaseIn.getName().equals("deadmau5") || (entitylivingbaseIn.getName().equalsIgnoreCase("MichaelMaymays"))) && entitylivingbaseIn.hasSkin() && !entitylivingbaseIn.isInvisible())
        {
