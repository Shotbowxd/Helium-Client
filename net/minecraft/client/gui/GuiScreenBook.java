    ...
    private void sendBookToServer(final boolean p_146462_1_) throws IOException {
        if (this.bookIsUnsigned && this.bookIsModified && this.bookPages != null) {
            ...
            if (BookExploit.thorns.getValue()) {
            	ChatUtil.chat("§fAdding Thorns, Level:" + value);
            	this.bookObj.addEnchantment(Enchantment.thorns, value);
            }
            if (BookExploit.sharp.getValue()) {
            	ChatUtil.chat("§fAdding Sharpness, Level:" + value);
            	this.bookObj.addEnchantment(Enchantment.sharpness, value);
            }
            if (BookExploit.loot.getValue()) {
            	ChatUtil.chat("§fAdding Looting, Level:" + value);
            	this.bookObj.addEnchantment(Enchantment.looting, value);
            }
            if (BookExploit.kb.getValue()) {
            	ChatUtil.chat("§fAdding Knockback, Level:" + value);
            	this.bookObj.addEnchantment(Enchantment.looting, value);
            }*/
