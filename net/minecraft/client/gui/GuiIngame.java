...
import rip.helium.event.events.impl.render.Render2DEvent;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        //TODO: Client
        	...
        	EventManager.call(new RenderHUDEvent(i, j, this.mc.fontRendererObj));
        }
        
        //TODO: Client
        EventManager.call(new Render2DEvent(i, j, this.mc.fontRendererObj));
        ...
        if (this.recordPlayingUpFor > 0)
        {
            ...
            if (k1 > 8)
            {
                ...
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.recordPlaying, -Minecraft.getMinecraft().fontRendererObj.getStringWidth(this.recordPlaying) / 2, -4, i1 + (k1 << 24 & -16777216));
                GlStateManager.disableBlend();
        ...
        if (this.field_175195_w > 0)
        {
            ...
            if (l1 > 8)
            {
                ...
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.field_175201_x, (float)(-Minecraft.getMinecraft().fontRendererObj.getStringWidth(this.field_175201_x) / 2), -10.0F, 16777215 | j2);
                GlStateManager.popMatrix();
                GlStateManager.pushMatrix();
                GlStateManager.scale(2.0F, 2.0F, 2.0F);
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(this.field_175200_y, (float)(-Minecraft.getMinecraft().fontRendererObj.getStringWidth(this.field_175200_y) / 2), 5.0F, 16777215 | j2);
                GlStateManager.popMatrix();
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
    ...
    public void renderExpBar(ScaledResolution p_175176_1_, int p_175176_2_)
    {
        ...
        if (this.mc.thePlayer.experienceLevel > 0)
        {
            ...
            int i1 = (p_175176_1_.getScaledWidth() - Minecraft.getMinecraft().fontRendererObj.getStringWidth(s)) / 2;
            int l = p_175176_1_.getScaledHeight() - 31 - 4;
            boolean flag = false;
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(s, i1 + 1, l, 0);
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(s, i1 - 1, l, 0);
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(s, i1, l + 1, 0);
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(s, i1, l - 1, 0);
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(s, i1, l, j1);
            this.mc.mcProfiler.endSection();
        }
    }
    ...
    public void func_181551_a(ScaledResolution p_181551_1_)
    {
        ...
        if (this.remainingHighlightTicks > 0 && this.highlightingItemStack != null)
        {
            ...
            int i = (p_181551_1_.getScaledWidth() - Minecraft.getMinecraft().fontRendererObj.getStringWidth(s)) / 2;
    ...
    public void renderDemo(ScaledResolution p_175185_1_)
    {
        ...
        int i = Minecraft.getMinecraft().fontRendererObj.getStringWidth(s);
        Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(s, (float)(p_175185_1_.getScaledWidth() - i - 10), 5.0F, 16777215);
        this.mc.mcProfiler.endSection();
    }
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        for (Object score1 : arraylist1)
        {
            ...
            drawRect(j - 2, l, i1, l + 12, 1342177280);
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(s1, j, l, 553648127);
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(s2, i1 - Minecraft.getMinecraft().fontRendererObj.getStringWidth(s2), l, 553648127);

            if (k == arraylist1.size())
            {
                String s3 = p_180475_1_.getDisplayName();
                drawRect(j - 2, l - 12 - 1, i1, l - 1, 1610612736);
                drawRect(j - 2, l - 1, i1, l, 1342177280);
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(s3, j + i / 2 - Minecraft.getMinecraft().fontRendererObj.getStringWidth(s3) / 2, l - 12, 553648127);
            }
        }
    }
    ...
    private void renderBossHealth()
    {
        if (BossStatus.bossName != null && BossStatus.statusBarTime > 0)
        {
            ...
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(s, (float)(i / 2 - Minecraft.getMinecraft().fontRendererObj.getStringWidth(s) / 2), (float)(b0 - 10), l);
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            this.mc.getTextureManager().bindTexture(icons);
        }
    }
